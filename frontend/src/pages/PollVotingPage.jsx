...
const PollVotingPage = () => {
  ...
  const handleRequestOtp = async () => {
    ...
    setError('');
    try {
      await authService.requestVoteOtp(id, votingData.phone_number);
      setOtpSent(true);
            ...
            {!otpSent ? (
                  ...
                  <div className="flex gap-3">
                    <div className="relative flex-1">
                      ...
                      <input 
                        type="tel" 
                        required 
                        className="w-full pl-14 pr-6 py-5 bg-slate-50 border border-slate-200 rounded-[1.5rem] font-black text-lg outline-none focus:ring-4 focus:ring-primary-100 shadow-inner" 
              ...
              <div className="space-y-12 animate-in slide-in-from-bottom-4">
                <div className="space-y-6">
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] text-center">Cast Your Decision Packet</label>
                ...
                <div className="pt-12 border-t-2 border-dashed border-slate-100 space-y-8">
                  <div className="space-y-4 text-center max-w-sm mx-auto">
                    <label className="block text-[10px] font-black text-primary-600 uppercase tracking-[0.4em]">Authorization Packet</label>
                    <input 
                      type="text" 
                      maxLength="6" 
