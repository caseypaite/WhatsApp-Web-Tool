                ...
                <div className="wp-card flex-1 w-full lg:max-w-md h-[600px] flex flex-col">
                  <div className="p-4 border-b border-[#dcdcde] bg-[#f6f7f7]">
                    ...
                    <section className="space-y-3">
                      ...
                      <div className="space-y-1">
                        {[
                          { n: 'Engine Status (v1)', m: 'GET', p: '/v1/status', k: true, mo: true, d: 'Check connection status' },
                          { n: 'Broadcast Node (v1)', m: 'POST', p: '/v1/broadcast', k: true, mo: true, d: 'Unified transmission to multiple targets', b: '{"targets": [{"id": "91XXXXXXXXXX@c.us", "type": "individual"}], "message": "Broadcast content", "mediaUrl": "", "mediaType": "image"}' },                          { n: 'Direct Channel (v1)', m: 'POST', p: '/v1/message/channel', k: true, mo: true, d: 'Publish to a channel newsletter', b: '{"channelId": "120363XXXXXXXXXXXX@newsletter", "message": "Channel publication", "mediaUrl": "", "mediaType": "image"}' },
